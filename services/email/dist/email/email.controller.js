...
const send_bulk_email_dto_1 = require("./dto/send-bulk-email.dto");
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Send bulk email' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [send_bulk_email_dto_1.SendBulkEmailDto]),
    __metadata("design:returntype", Promise)
], EmailController.prototype, "sendBulkEmail", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get email status' }),
